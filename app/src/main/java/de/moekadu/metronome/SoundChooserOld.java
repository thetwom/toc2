...
//
//public class SoundChooserOld extends FrameLayout {
//
...
//    }
//
//    public SoundChooserOld(Context context) {
//        super(context);
//        this.context = context;
//    }
//
//    public SoundChooserOld(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        this.context = context;
//        readAttributes(attrs);
//    }
//
//    public SoundChooserOld(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SoundChooserOld);
//        highlightButtonColor = ta.getColor(R.styleable.SoundChooserOld_highlightColor, Color.BLUE);
//        normalButtonColor = ta.getColor(R.styleable.SoundChooserOld_normalColor, Color.BLACK);
//        volumeButtonColor = ta.getColor(R.styleable.SoundChooserOld_volumeColor, Color.RED);
//
//        ta.recycle();
//    }
//
