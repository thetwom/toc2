...
class PlayButton(context : Context, attrs : AttributeSet?, defStyleAttr: Int)
    ...
    constructor(context : Context, attrs : AttributeSet? = null) : this(context, attrs, R.attr.playButtonStyle)
    ...
    init {
         attrs?.let {
            val ta = context.obtainStyledAttributes(attrs, R.styleable.PlayButton, defStyleAttr, R.style.Widget_AppTheme_PlayButtonStyle)
