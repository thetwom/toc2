...
//
//    private final NoteListItem properties = new NoteListItem(Sounds.defaultSound(), 1.0f, -1);
//
...
//    }
//
//    public NoteListItem getProperties(){
//        return properties;
//    }
//
//    public void setProperties(NoteListItem newProperties, boolean suppressOnPropertiesChangedListener) {
//
//        properties.set(newProperties);
//        icon = ContextCompat.getDrawable(getContext(), Sounds.getIconID(properties.getId()));
//        invalidate();
